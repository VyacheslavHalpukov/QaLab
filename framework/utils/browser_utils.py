...
class Browser(metaclass=Singleton):
    ...
    @staticmethod
    def find_elements(locator: tuple[By, str]) -> List[WebElement]:
        """
        Search for elements and returns them
        :arg:
         -locator: tuple with By and locator values
        :returns: list of selenium WebElements
        """
        Logger.info(f"Searching elements by {locator} locator")
        return Browser.get_driver().find_elements(*locator)
